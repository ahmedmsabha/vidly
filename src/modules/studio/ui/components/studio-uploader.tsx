    ...
    <div>
      ...
      <MuxUploaderDrop muxUploader={UPLOADER_ID} className="group/drop">
        <div slot="heading" className="flex flex-col items-center gap-6">
          <div className="flex justify-center items-center gap-2 rounded-full bg-muted h-32 w-32">
          ...
          <div className="flex flex-col gap-2 text-center">
            <p className="text-sm font-medium">
              Drag and video files to upload
            </p>
            <p className="text-xs text-muted-foreground">
              Your videos will be private until you push them
            </p>
          </div>
          <MuxUploaderFileSelect muxUploader={UPLOADER_ID}>
            <Button type="button" className="full-rounded">
